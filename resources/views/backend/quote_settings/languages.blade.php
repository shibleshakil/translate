                                                        ...
                                                        <td>
                                                            @if ($data->trashed())
                                                                <button type="button" class="btn btn-outline-warning" title="Resotre"
                                                                    onclick="restoreData('{{ route('admin.quote-settings.languages.restore', [$data->id]) }}')">
                                                            ...
                                                            @else
                                                                ...
                                                                <button type="button" class="btn btn-outline-danger" title="Trash"
                                                                    onclick="deleteData('{{ route('admin.quote-settings.languages.delete', [$data->id]) }}')">
    ...
    <div class="modal fade text-left" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route ('admin.quote-settings.languages.store') }}" method="post" class="form" enctype="multipart/form-data">@csrf
    ...
    <div class="modal fade text-left" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route ('admin.quote-settings.languages.update') }}" method="post" class="form" enctype="multipart/form-data">@csrf
                    <div class="modal-body">
