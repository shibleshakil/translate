...
@section('title', 'Experience and Expertise')
...
<div class="content-wrapper">
        ...
        <div class="content-header-left col-md-6 col-12 mb-1">
            <h3 class="content-header-title">
                <a href="#" data-toggle="modal" data-target="#addModal" class="btn btn-primary">
                    {{ __('Add Experience and Expertise') }} <i class="feature icon-plus"></i>
                </a>
            </h3>
        </div>
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ __('Experience and Expertises') }}</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card rounded">
                        <div class="card-header">
                            <h4 class="card-title">Experience and Expertises</h4>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        <thead>
                                            <tr>
                                                <th>Sl</th>
                                                <th>Experience and Expertise</th>
                                                <th>Status</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                                        ...
                                                        <td>
                                                            @if ($data->trashed())
                                                                <button type="button" class="btn btn-outline-warning" title="Resotre"
                                                                    onclick="restoreData('{{ route('admin.settings.experience-and-expertise.restore', [$data->id]) }}')">
                                                            ...
                                                            @else
                                                                ...
                                                                <button type="button" class="btn btn-outline-danger" title="Trash"
                                                                    onclick="deleteData('{{ route('admin.settings.experience-and-expertise.delete', [$data->id]) }}')">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel18"> Add New Experience and Expertise</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route ('admin.settings.experience-and-expertise.store') }}" method="post" class="form" enctype="multipart/form-data">@csrf
    ...
    <div class="modal fade text-left" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel18"> Update Experience and Expertise</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route ('admin.settings.experience-and-expertise.update') }}" method="post" class="form" enctype="multipart/form-data">@csrf
                    <div class="modal-body">
