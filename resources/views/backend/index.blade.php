                ...
                <div class="card">
                    <div class="card-header latest-update-heading d-flex justify-content-between">
                        ...
                        <div class="dropdown update-year-menu pb-1">
                            <a class="bg-transparent dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">2019</a>
                                ...
                                <tbody>
                                        ...
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="{{ asset ('public/backend/app-assets/images/portrait/small/avatar-s-11.png') }}"
                                    ...
                                    <tr>
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="{{ asset ('public/backend/app-assets/images/portrait/small/avatar-s-14.png') }}"
                                                    alt="Generic placeholder image">
                                            </div>
                                    ...
                                    <tr>
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="{{ asset ('public/backend/app-assets/images/portrait/small/avatar-s-15.png') }}"
                                                    alt="Generic placeholder image">
                                            </div>
                                    ...
                                    <tr>
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="{{ asset ('public/backend/app-assets/images/portrait/small/avatar-s-4.png') }}"
                                                    alt="Generic placeholder image">
                                            </div>
                                    ...
                                    <tr>
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="{{ asset ('public/backend/app-assets/images/portrait/small/avatar-s-19.png') }}"
                                                    alt="Generic placeholder image">
                                            </div>
                                        ...
                                        <td class="align-middle">
                                            <div class="progress my-75">
                                                <div class="progress-bar progress-bar-striped bg-danger"
                                                    role="progressbar" aria-valuenow="20" aria-valuemin="20"
                                                    aria-valuemax="100" style="width:47%">47%</div>
                                            </div>
                                        </td>
                                        <td class="align-middle">
                                        ...
                                        <div>
                                            <ul
                                                ...
                                                <li class="avatar avatar-sm pull-up my-0">
                                                    <img class="rounded-circle"
                                                        src="{{ asset ('public/backend/app-assets/images/portrait/small/avatar-s-20.png') }}"
                                    ...
                                    <li class="timeline-items timeline-icon-info">
                                        ...
                                        <div>
                                            <ul
                                                ...
                                                <li class="avatar avatar-sm pull-up my-0">
                                                    <img class="rounded-circle"
                                                        src="{{ asset ('public/backend/app-assets/images/portrait/small/avatar-s-21.png') }}"
                                                        alt="Generic placeholder image" data-toggle="tooltip"
                                                        data-placement="top" title="Stepan">
                                                </li>
                                                <li class="avatar avatar-sm pull-up my-0">
                                                    <img class="rounded-circle"
                                                        src="{{ asset ('public/backend/app-assets/images/portrait/small/avatar-s-22.png') }}"
                                                        alt="Generic placeholder image" data-toggle="tooltip"
...
@section('script')
<script src="{{ asset ('public/backend/app-assets/vendors/js/charts/apexcharts/apexcharts.min.js') }}"></script>
<script src="{{ asset ('public/backend/app-assets/js/scripts/cards/card-statistics.js') }}"></script>
@endsection
